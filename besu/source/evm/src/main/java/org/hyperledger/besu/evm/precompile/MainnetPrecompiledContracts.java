...
public interface MainnetPrecompiledContracts {
  ...
  static void populateForCancun(
    ...
    registry.put(
        Address.fromHexString(FheConstants.PRECOMPILE_ADDRESS),
        new FheDispatcherPrecompiledContract(gasCalculator));
    registry.put(
        Address.fromHexString(FheConstants.ZK_VERIFY_PRECOMPILE_ADDRESS),
        new ZkVerifierPrecompiledContract(gasCalculator));
  }
