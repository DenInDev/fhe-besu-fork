...
/// @notice ZK operation-proof adapter for proof-backed FHE results.
/// @dev The Noir circuit proves knowledge of a coprocessor secret whose
/// Poseidon commitment is authorized, and binds that secret to the operation
/// digest. It does not prove the full TFHE semantics.
///
/// The proof payload is ABI-encoded as:
/// `(bytes32,bytes32,bytes,bytes32[])`, i.e. authorityCommitment,
/// attestationHash, Noir proof bytes and Noir public inputs.
contract NoirOperationProofVerifierAdapter is IOperationProofVerifier {
    ...
    /// @notice Public input order generated by the Noir circuit:
    /// operationDigestHi, operationDigestLo, authorityCommitment, attestationHash.
